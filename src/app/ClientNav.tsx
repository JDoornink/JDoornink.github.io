...
export default function ClientNav() {
  ...
  return (
    <>
      <a href="#certifications" onClick={(e) => handleScroll(e, 'certifications')} className="flex-1 text-center px-3 py-1.5 bg-emerald-900/20 border border-emerald-500/50 text-emerald-300 rounded hover:bg-emerald-900/40 transition-colors">Certifications</a>
